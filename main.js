...
if (connection == 'open') {
console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ 𝖲𝖺𝗉𝗂𝗍𝗈 𝖻𝗈𝗍 𝗌𝖾 𝖼𝗈𝗇𝖾𝖼𝗍𝗈 𝖺𝗅 𝗐𝖺𝗌𝖺𝗉 ☯︎\n│\n▣──────────────────────────────···'))}
if (connection == 'close') {
...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝙷𝙰𝚂𝚃𝙰 𝙿𝚁𝙾𝙽𝚃𝙾 👋🏻* \n*╚══════════════*'
conn.spromote = '*𝑇𝑒𝑛𝑒𝑚𝑜𝑠 𝑢𝑛 𝑛𝑢𝑒𝑣𝑜 𝑎𝑑𝑚𝑖𝑛 𝑏𝑖𝑒𝑛𝑣𝑒𝑛𝑖𝑑@ @user ✯*'
conn.sdemote = '* 𝐶ℎ𝑎𝑙𝑒 @user 𝑦𝑎 𝑛𝑜 𝑒𝑠 𝑎𝑑𝑚𝑖𝑛 :𝑣 !!*'
...
let bio = `🤖 Sapito Bot 🐸 | 🕒 Tiempo activo: ${uptime} ┃ 👑 SNT  :)`
